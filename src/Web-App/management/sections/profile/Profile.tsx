...
function Profile() {
  return (
    <div className="h-[82vh] w-full rounded-2xl shadow-[0_4px_25px_rgba(0,0,0,0.4)] hover:shadow-[0_8px_40px_rgba(0,0,0,0.5)] transition-all duration-500 ease-out flex flex-col justify-between p-8 backdrop-blur-md">
